//! Triangle wave oscillator - flute-like, soft
...
impl OscTriangle {
    ...
    fn process_sample(&mut self) -> f32 {
        ...
        let output = (2.0 * (2.0 * self.phase - 1.0).abs() - 1.0) * self.amp;
...
impl Default for OscTriangle {
    fn default() -> Self { Self::new() }
}

impl DspNode for OscTriangle {
...
impl crate::NodeDescriptor for OscTriangle {
    fn type_name(&self) -> &'static str { "OscTriangle" }
    fn ports(&self) -> &'static [PortSpec] { PORTS }
    fn params(&self) -> &'static [ParamSpec] { PARAMS }
    fn display_name(&self) -> &'static str { "Triangle Oscillator" }
